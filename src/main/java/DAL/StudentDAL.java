...
public class StudentDAL extends MyDatabaseManager {
    ...
    public void readStudents() throws SQLException {
        ...
        if (rs != null) {
            int i = 1;
            System.out.println("TT \t PersonID \t FirstName \t\t LastName\t EnrollmentDate");
            while (rs.next()) {
    ...
    public Student getStudent(int personID) throws SQLException {
        ...
        PreparedStatement p = StudentDAL.connectDB().prepareStatement(query);
        p.setInt(1, personID);
    ...
    public static void main(String[] args) {
        //System.out.println(getClass().getResource("/Icon/university128.png"));
